...
const ENDPOINT_URL = "https://sshibinthomass--trellis-2-4b-trellis2model-generate-api.modal.run";
...
async function testInference(imgPath: string): Promise<Buffer> {
  ...
  console.log("Sending request to Trellis 2-4B secure endpoint...");
...
async function main() {
  ...
  try {
    ...
    const filename = `${inputStem}_trellis_${timestamp}.glb`;
